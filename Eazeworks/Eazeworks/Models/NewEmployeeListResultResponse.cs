...
{
    public class NewEmployeeListResultResponse
    {
        public NewEmployeeListResult NewEmployeeListResult { get; set; }
    }
    ...
    public class Data
    {
        ...
        public List<CustomAdditionals> CustomAdditional { get; set; }
        public List<CustomOfficials> CustomOfficial { get; set; }
        public List<CustomPersonals> CustomPersonal { get; set; }
    ...
    public class NewEmployeeListResult
    {
